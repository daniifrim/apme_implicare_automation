...
export function AutomationSettingsPanel({
  ...
  return (
    <div className="space-y-6">
      <Card className={localSettings.maintenanceMode ? 'border-yellow-500' : ''}>
        <CardHeader>
          ...
          <CardDescription>Control system-wide automation behavior</CardDescription>
        </CardHeader>
            ...
            <div className="p-4 rounded-lg bg-yellow-50 border border-yellow-200">
              <div className="flex items-start gap-3">
                ...
                <div className="text-sm text-yellow-800">
                  <p className="font-medium">Warning: Maintenance Mode Active</p>
                  <p>All automations are paused. New submissions will be queued but not processed.</p>
                </div>
              </div>
            </div>
          )}
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Configure automatic submission processing</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="flex items-center justify-between">
            <div className="space-y-0.5">
              <Label className="font-medium">Enable Auto-Processing</Label>
              <p className="text-sm text-muted-foreground">Automatically process new submissions as they arrive</p>
            </div>
            <Switch
              checked={localSettings.autoProcessEnabled}
              onCheckedChange={(checked) => handleChange({ autoProcessEnabled: checked })}
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              <Badge variant="secondary">{localSettings.batchSize} submissions</Badge>
            </div>
            <Input
              id="batchSize"
              type="range"
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              <Badge variant="secondary">{localSettings.processingTimeout}s</Badge>
            </div>
            <Input
              ...
              onChange={(e) => handleChange({ processingTimeout: parseInt(e.target.value) })}
            />
            <p className="text-xs text-muted-foreground">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Configure automatic retry behavior for failed operations</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="flex items-center justify-between">
            <div className="space-y-0.5">
              <Label className="font-medium">Enable Auto-Retry</Label>
              <p className="text-sm text-muted-foreground">Automatically retry failed operations</p>
            </div>
            <Switch
              checked={localSettings.autoRetryEnabled}
              onCheckedChange={(checked) => handleChange({ autoRetryEnabled: checked })}
            />
          </div>
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              <Badge variant="secondary">{localSettings.maxRetries} attempts</Badge>
            </div>
            <Input
              id="maxRetries"
              type="range"
