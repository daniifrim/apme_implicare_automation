...
describe('PreviewPanel', () => {
  ...
  describe('Submission Selection', () => {
    ...
    it.skip('displays all submissions in dropdown', async () => {
      ...
      await waitFor(() => {
        mockSubmissions.forEach(sub => {
          expect(screen.getByText(`${sub.firstName} ${sub.lastName}`)).toBeInTheDocument()
        })
      })
    })
    ...
    it.skip('calls onSubmissionChange when submission is selected', async () => {
      ...
      render(<PreviewPanel {...defaultProps} onSubmissionChange={onSubmissionChange} />)
  ...
  describe('Action Buttons', () => {
    ...
    it('renders reset view button', () => {
      ...
      const resetButton = screen.getByRole('button', { name: /reset to desktop view/i })
  ...
  describe('Accessibility', () => {
    it('has proper ARIA labels on device toggles', () => {
      ...
      expect(screen.getByRole('radio', { name: /desktop/i })).toHaveAttribute('aria-label', 'Desktop')
      expect(screen.getByRole('radio', { name: /tablet/i })).toHaveAttribute('aria-label', 'Tablet')
      expect(screen.getByRole('radio', { name: /mobile/i })).toHaveAttribute('aria-label', 'Mobile')
    })
  })
})
