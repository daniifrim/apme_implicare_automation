...
describe('Template Editing Flow - Integration', () => {
  ...
  const mockVersions = [
    ...
    },
    {
      ...
      editorState: [{ type: 'paragraph', content: 'Welcome {{FirstName}} {{LastName}}!' }],
  ...
  const mockSubmissions = [
    { id: 'sub-1', firstName: 'John', lastName: 'Doe', email: 'john@example.com' },
    { id: 'sub-2', firstName: 'Jane', lastName: 'Smith', email: 'jane@example.com' }
  ]
  ...
  describe('Publishing Workflow', () => {
    ...
    it('shows warning when replacing published version', async () => {
      ...
      await waitFor(() => {
        expect(screen.getByText(/replacing current published version/i)).toBeInTheDocument()
      })
    })
  })
