...
export default function TemplateEditorPage() {
  ...
  const fetchData = async () => {
    try {
      ...
      const draftVersion = versionsData.versions.find(
        (v: TemplateVersion) => !v.isPublished,
      );
  ...
  return (
    <div className="h-[calc(100vh-8rem)] flex flex-col">
      ...
      <div className="flex items-center justify-between mb-6 shrink-0">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              {template.slug} • {versions.length} version
              {versions.length !== 1 ? "s" : ""}
            </p>
          </div>
          {isPublished && (
        ...
        <div className="flex items-center gap-2">
          ...
          <Button
            ...
            disabled={
              publishing || !selectedVersion || selectedVersion.isPublished
            }
            className="hidden sm:flex"
          >
            {publishing ? (
      ...
      {/* Desktop: Two-Tab Layout with Resizable Panels */}
      ...
      <div className="lg:hidden flex flex-1 flex-col min-h-0">
        ...
        >
          ...
          <TabsContent
            ...
            className="flex-1 min-h-0 mt-0 data-[state=active]:flex"
          >
            <div className="flex-1 rounded-xl border bg-background shadow-sm overflow-auto p-4">
              <div className="max-w-4xl mx-auto">
                <EditorPanel
                  formData={formData}
                  editorContent={editorContent}
        ...
        <DialogContent className="w-[95vw] max-w-[95vw] sm:max-w-lg">
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              <strong>{selectedVersion?.name}</strong>? This will make it the
              active version for all new emails.
            </DialogDescription>
          </DialogHeader>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-amber-700 mt-1">
                    v{publishedVersion.versionNumber}: {publishedVersion.name}{" "}
                    is currently published. Publishing this version will replace
                    it.
                  </p>
                </div>
              </div>
          ...
          <div className="space-y-3 my-4">
            <div className="text-sm">
              ...
              <span className="font-medium">
                v{selectedVersion?.versionNumber}: {selectedVersion?.name}
              </span>
            </div>
            <div className="text-sm">
            ...
            <div className="text-sm">
              ...
              <span className="font-medium">
                {selectedVersion?.placeholders.length || 0}
              </span>
            </div>
          </div>
