...
describe('GET /api/submissions', () => {
  ...
  it('should return submissions with default pagination', async () => {
    const mockSubmissions = [
      { id: '1', email: 'test@example.com', firstName: 'Test', status: 'processed', assignments: [] },
      { id: '2', email: 'test2@example.com', firstName: 'Test2', status: 'pending', assignments: [] }
    ]
  ...
  it('should filter by status', async () => {
    ...
    const request = createMockRequest('http://localhost/api/submissions?status=processed')
  ...
  it('should filter by location type', async () => {
    ...
    const request = createMockRequest('http://localhost/api/submissions?location=romania')
  ...
  it('should filter by date range', async () => {
    ...
    const request = createMockRequest('http://localhost/api/submissions?from=2024-01-01&to=2024-01-31')
  ...
  it('should search by email, name, phone, and submission ID', async () => {
    ...
    const request = createMockRequest('http://localhost/api/submissions?search=john')
  ...
  it('should handle pagination', async () => {
    ...
    const request = createMockRequest('http://localhost/api/submissions?page=3&limit=10')
  ...
  it('should handle database errors', async () => {
    vi.mocked(prisma.submission.findMany).mockRejectedValue(new Error('Database error'))
