...
describe('POST /api/submissions/[id]/assignments', () => {
  ...
  it('should create assignment successfully', async () => {
    const mockTemplate = { id: 'template-1', name: 'Test Template', slug: 'test' }
    ...
    vi.mocked(prisma.assignment.create).mockResolvedValue(mockAssignment as never)
  ...
  it('should return 409 if assignment already exists', async () => {
    ...
    vi.mocked(prisma.assignment.findUnique).mockResolvedValue({ id: 'existing' } as never)
