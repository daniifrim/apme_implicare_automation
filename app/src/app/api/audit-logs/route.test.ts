...
describe('GET /api/audit-logs', () => {
  ...
  it('should filter by action type', async () => {
    const request = new NextRequest('http://localhost/api/audit-logs?action=created')
  ...
  it('should filter by resource type', async () => {
    const request = new NextRequest('http://localhost/api/audit-logs?resource=template')
  ...
  it('should filter by userId', async () => {
    const request = new NextRequest('http://localhost/api/audit-logs?userId=user-1')
  ...
  it('should enforce maximum limit of 100', async () => {
    const request = new NextRequest('http://localhost/api/audit-logs?limit=200')
  ...
  it('should search by resourceId', async () => {
    const request = new NextRequest('http://localhost/api/audit-logs?search=template-1')
